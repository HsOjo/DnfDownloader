...
class Ui_DownloadPage(object):
    def setupUi(self, DownloadPage):
        ...
        self.lw_file_l.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.lw_file_l.setAutoScroll(True)
        self.lw_file_l.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.lw_file_l.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        self.lw_file_l.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.lw_file_l.setFlow(QtWidgets.QListView.Flow.TopToBottom)
        ...
        self.lw_down_l.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.lw_down_l.setAutoScroll(True)
        self.lw_down_l.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.lw_down_l.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        self.lw_down_l.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.lw_down_l.setFlow(QtWidgets.QListView.Flow.TopToBottom)
        ...
        self.pb_clear_sel.clicked.connect(self.lw_file_l.clearSelection) # type: ignore
        self.pb_clear_sel.clicked.connect(self.lw_down_l.clearSelection) # type: ignore
